...
#define TIME_BALL_MOVE 2000 // ball's generating period
#define TIME_ITEM 4000      // item's generating period

#define FIXED_BALL_SPEED 0.006 // fixed speed

static float STATIC_BALL_SPEED = FIXED_BALL_SPEED; //ball speed control
...
CBox health[3];
CBox item[MAX_ITEM_NUM]; // test Box
