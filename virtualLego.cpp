     ...
     /*   if (vx > 0.01 || vz > 0.01)
        {
            ...
            //tX, tZ 는 테이블의 원점에서의 공의 거리
            if (tX >= (4.5 - M_RADIUS))                                    //벽과 공이 부딪히면 반대 방향으로 튕기는 현상 구현
            {
                tX = 4.5 - M_RADIUS;
...
bool Setup()
{
    ...
    std::uniform_int_distribution<int> int_distribution(1, 4);               //위치 생성 위한 난수 범위
    ...
    /*for (i = 0; i < 4; i++) {                                                   //기존의 미리 만들어진 객체 4개에 대해 위치 랜덤으로 생성하도록 구현했지만
...
LRESULT CALLBACK d3d::WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_KEYDOWN:                  //버튼 입력 변수
    {
        ...
        case VK_RETURN:               //엔터 키 누르면
            ...
            break;
        case VK_SPACE:               //스페이스 바 누르면
            /*                                                //스페이스 바 누르면 하얀 공이 움직이는 코드 주석처리
